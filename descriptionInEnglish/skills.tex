...
\vspace{-1mm}
\begin{itemize}[leftmargin=*]
  \item \justify{\textbf{Data Analysis and Visualization}: Proficiency with data analysis libraries such as Numpy, Scipy, Pandas, Tsfresh, and scientific plotting libraries such as Matplotlib, Seaborn, and Pyqtgraph.
  }
\end{itemize}

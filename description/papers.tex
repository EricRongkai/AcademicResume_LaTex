...
\vspace{-2mm}
  ...
  \begin{itemize}[leftmargin=*]
    \item 
    \justify{L. Tong, \textbf{R. Liu}, and L. Peng, “LSTM-Based Lower Limbs Motion Reconstruction Using Low-Dimensional Input of Inertial Motion Capture System,” \textit{IEEE Sensors Journal (J-SEN)}, vol. 20, no. 7, pp. 3667–3677, Apr. 2020.(IF:4.3, 导师一作)}
  \end{itemize}

  \vspace{-2.6mm}
  \begin{itemize}[leftmargin=*]
    \item 
    \justify{X. Zhao, \textbf{R. Liu}, T. Ma, H. Li, and Q. Song, “Real-time Gait Phase Estimation Based on Multi-source Flexible Sensors Fusion,” in Proceedings of the 2023 3rd International Conference on Robotics and Control Engineering, Nanjing China: ACM, May 2023, pp. 113–118. doi: 10.1145/3598151.3598223.(Best Paper)}
  \end{itemize}
